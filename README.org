...
- [[https://gitlab.com/gnutls/guile][guile-gnutls]] >= 3.7.0
...
** OCapN Test suite
If you're working on anything related to OCapN in guile goblins, it's
good to ensure the test suite still passes. The test suite and how to
run it is located [[https://github.com/ocapn/ocapn-test-suite][here]].
