...
This is a port of [[https://gitlab.com/spritely/goblins][Spritely Goblins]] to [[https://www.gnu.org/software/guile/][Guile]].  It's a distributed
programming system with local transactions and following object
capability security principles.  See [[https://gitlab.com/spritely/guile-goblins/-/blob/main/doc/goblins.org][the manual]] for more details.
...
#+BEGIN_SRC sh
  # You can also run this with --pure if it accidentally finds
  # your system guile
...
library's terms are really GPLv3+.
