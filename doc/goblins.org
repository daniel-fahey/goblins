...
# *TODO:* This is the worst looking example in the entire paper.  Wisp
# could learn a thing or two from Wraith and treat keywords as always
# /not/ being parenthesized subexpressions.  (Even Wisp's primary author
# agreed that this was one area Wraith improved over Wisp.)  We might
# want to make our own variant of Wisp for this document before the
# final version.
...
#+BEGIN_SRC scheme
  ...
  > ($ horatio 'get-times-called)
  ; => 0
  > ($ horatio 'greet "Hamlet")
